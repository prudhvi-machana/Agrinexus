...
def add_crop(aadhar_id):
    ...
    if land:
        ...
        cursor.execute("""
            INSERT INTO crops (land_id, crop_name, crop_size, soil_ph, planting_date, harvest_date, crop_suggestion, aadhar_id)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
        """, (land_id, crop_name, crop_size, soil_ph, planting_date, harvest_date, crop_suggestion, aadhar_id))
